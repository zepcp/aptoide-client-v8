...
import cm.aptoide.pt.view.account.UriToPathResolver;
import cm.aptoide.pt.view.account.exception.InvalidImageException;
import cm.aptoide.pt.view.account.exception.StoreCreationException;
...
public class ManageStorePresenter implements Presenter {
  ...
  private Completable handleSaveClick(ManageStoreFragment.StoreViewModel storeModel) {
  ...
  private Completable saveData(ManageStoreFragment.StoreViewModel storeModel) {
