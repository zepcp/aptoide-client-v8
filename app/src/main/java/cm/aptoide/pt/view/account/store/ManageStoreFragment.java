...
import cm.aptoide.pt.view.account.ImagePickerPresenter;
import cm.aptoide.pt.view.account.ImageValidator;
import cm.aptoide.pt.view.account.PhotoFileGenerator;
