...
public class DownloadTask extends FileDownloadLargeFileListener {
  ...
  public Download updateProgress() {
    if (download.getOverallProgress() >= AptoideDownloadManager.PROGRESS_MAX_VALUE || download.getOverallDownloadStatus() != Download.PROGRESS) {
      return download;
    }
    ...
    Logger.d(TAG, "Download: " + download.getAppId() + " Progress: " + download.getOverallProgress());
    return download;
  }
  ...
  protected void error(BaseDownloadTask task, Throwable e) {
    if (e instanceof FileDownloadHttpException && ((FileDownloadHttpException) e).getCode() == FILE_NOTFOUND_HTTP_ERROR) {
