            ...
            if (Application.getConfiguration()
              ...
              AlertDialog.Builder alertDialog =
                  sharePreviewDialog.getCustomRecommendationPreviewDialogBuilder(getContext(),
                      appName, app.getIcon(), app.getStats()
                          .getRating()
                          .getAvg());
              ...
              sharePreviewDialog.showShareCardPreviewDialog(packageName, app.getStore()
                  .getId(), "app", getContext(), sharePreviewDialog, alertDialog, socialRepository);
            }
